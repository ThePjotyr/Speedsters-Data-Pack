execute unless score .TIME_RUNNING_RATE speedsters.time_running matches -2147483648..2147483647 run scoreboard players set .TIME_RUNNING_RATE speedsters.time_running 1
...
execute unless score .TIME_RUNNING_RATE_VEL speedsters.time_running matches -2147483648..2147483647 run scoreboard players set .TIME_RUNNING_RATE_VEL speedsters.time_running 2
...
execute unless score .TIME_RUN_SUIT_RATE speedsters.time_running matches -2147483648..2147483647 run scoreboard players set .TIME_RUN_SUIT_RATE speedsters.time_running 3
#Rate at which speedster with suit gains velocity. Higher number means greater speeds at shorter period of time. (Default: 3)

execute unless score .TIME_RUN_SUIT_RATE_VEL speedsters.time_running matches -2147483648..2147483647 run scoreboard players set .TIME_RUN_SUIT_RATE_VEL speedsters.time_running 5
...
execute unless score .LVL_SPEED_0 speedsters.time_running matches -2147483648..2147483647 run scoreboard players set .LVL_SPEED_0 speedsters.time_running 1
execute unless score .LVL_SPEED_1 speedsters.time_running matches -2147483648..2147483647 run scoreboard players set .LVL_SPEED_1 speedsters.time_running 5
execute unless score .LVL_SPEED_2 speedsters.time_running matches -2147483648..2147483647 run scoreboard players set .LVL_SPEED_2 speedsters.time_running 15
execute unless score .LVL_SPEED_3 speedsters.time_running matches -2147483648..2147483647 run scoreboard players set .LVL_SPEED_3 speedsters.time_running 30
execute unless score .LVL_SPEED_4 speedsters.time_running matches -2147483648..2147483647 run scoreboard players set .LVL_SPEED_4 speedsters.time_running 80
execute unless score .LVL_SPEED_5 speedsters.time_running matches -2147483648..2147483647 run scoreboard players set .LVL_SPEED_5 speedsters.time_running 160
execute unless score .LVL_SPEED_6 speedsters.time_running matches -2147483648..2147483647 run scoreboard players set .LVL_SPEED_6 speedsters.time_running 390
execute unless score .LVL_SPEED_7 speedsters.time_running matches -2147483648..2147483647 run scoreboard players set .LVL_SPEED_7 speedsters.time_running 840
execute unless score .LVL_SPEED_8 speedsters.time_running matches -2147483648..2147483647 run scoreboard players set .LVL_SPEED_8 speedsters.time_running 1000
execute unless score .LVL_SPEED_9 speedsters.time_running matches -2147483648..2147483647 run scoreboard players set .LVL_SPEED_9 speedsters.time_running 1200
