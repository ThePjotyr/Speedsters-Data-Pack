...
#Turn on/off speedsters ability to run on liquid. (Default: 1, 1 - on, 0 - off)

scoreboard players set .WALL_RUNNING Config 1
#Turn on/off speedsters ability to run on walls. (Default: 1, 1 - on, 0 - off)

scoreboard players set .SKIP_BLOCK Config 1
#Turn on/off speedsters ability to skip blocks while running. (Default: 1, 1 - on, 0 - off)

scoreboard players set .DIMENSION_TRAVEL Config 1
#Turn on/off speedsters ability to travel between dimensions. (Default: 1, 1 - on, 0 - off)