...
execute unless entity @s[tag=PA_fueled_tachyon] if score @s Time_PA_Stand >= .PA_EXP_0 Time_PA_Stand if score @s Time_PA_Stand < .PA_EXP_1 Time_PA_Stand as @s at @s run tag @a[tag=!ParticleACCProximity,distance=..3] add ParticleACCProximity
execute unless entity @s[tag=PA_fueled_tachyon] if score @s Time_PA_Stand >= .PA_EXP_1 Time_PA_Stand if score @s Time_PA_Stand < .PA_EXP_2 Time_PA_Stand as @s at @s run tag @a[tag=!ParticleACCProximity,distance=..4] add ParticleACCProximity
execute unless entity @s[tag=PA_fueled_tachyon] if score @s Time_PA_Stand >= .PA_EXP_2 Time_PA_Stand if score @s Time_PA_Stand < .PA_EXP_3 Time_PA_Stand as @s at @s run tag @a[tag=!ParticleACCProximity,distance=..5] add ParticleACCProximity
execute unless entity @s[tag=PA_fueled_tachyon] if score @s Time_PA_Stand >= .PA_EXP_3 Time_PA_Stand if score @s Time_PA_Stand < .PA_EXP_4 Time_PA_Stand as @s at @s run tag @a[tag=!ParticleACCProximity,distance=..7] add ParticleACCProximity
execute unless entity @s[tag=PA_fueled_tachyon] if score @s Time_PA_Stand >= .PA_EXP_4 Time_PA_Stand if score @s Time_PA_Stand < .PA_EXP_5 Time_PA_Stand as @s at @s run tag @a[tag=!ParticleACCProximity,distance=..10] add ParticleACCProximity
execute unless entity @s[tag=PA_fueled_tachyon] if score @s Time_PA_Stand >= .PA_EXP_5 Time_PA_Stand if score @s Time_PA_Stand < .PA_MAX Time_PA_Stand as @s at @s run tag @a[tag=!ParticleACCProximity,distance=..15] add ParticleACCProximity
