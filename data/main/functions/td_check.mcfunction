...
execute if entity @s[tag=TachyonDevice,scores={flash.use_td=1..}] as @s[tag=TachyonDevice,scores={flash.use_td=1..}] at @s anchored eyes run function main:td_remove_block
execute if entity @s[tag=TachyonDeviceP,scores={flash.use_td=1..}] as @s[tag=TachyonDeviceP,scores={flash.use_td=1..}] at @s anchored eyes run function main:td_remove_block_p
execute if entity @s[tag=TachyonDeviceN,scores={flash.use_td=1..}] as @s[tag=TachyonDeviceN,scores={flash.use_td=1..}] at @s anchored eyes run function main:td_remove_block_n
execute if entity @s[tag=TachyonDeviceFrame,scores={flash.use_td=1..}] as @s[tag=TachyonDeviceFrame,scores={flash.use_td=1..}] at @s anchored eyes run function main:td_remove_block_frame
...
execute if entity @s[scores={flash.use_td=1..}] as @s[scores={flash.use_td=1..}] run scoreboard players set @s flash.use_td 0