...
execute if entity @s[tag=!PA_powered] as @s[tag=!PA_powered] run scoreboard players set @s flash.time_pa 0
execute if entity @s[tag=!PA_fueled] as @s[tag=!PA_fueled] run scoreboard players set @s flash.time_pa 0