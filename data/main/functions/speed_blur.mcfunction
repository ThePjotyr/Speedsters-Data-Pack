execute if entity @s[tag=SpeedLvl12] as @s[tag=SpeedLvl12] run scoreboard players add @s flash.time_speed_blur 10
execute if entity @s[tag=SpeedLvl35] as @s[tag=SpeedLvl35] run scoreboard players add @s flash.time_speed_blur 5
execute if entity @s[tag=SpeedLvl69] as @s[tag=SpeedLvl69] run scoreboard players add @s flash.time_speed_blur 3
execute if entity @s[tag=SpeedLvl10] as @s[tag=SpeedLvl10] run scoreboard players add @s flash.time_speed_blur 1

teleport @s[tag=SpeedForceBlur] ^ ^ ^0.5 facing entity @p[tag=SpeedForce,scores={flash.time_running=1..},predicate=main:is_running] feet
teleport @s[tag=NSpeedForceBlur] ^ ^ ^0.5 facing entity @p[tag=NegativeSpeedForce,scores={flash.time_running=1..},predicate=main:is_running] feet
teleport @s[tag=Velocity9Blur] ^ ^ ^0.5 facing entity @p[tag=Velocity9,scores={flash.time_running=1..},predicate=main:is_running] feet
...
execute if entity @s[tag=SpeedLvl12,scores={flash.time_speed_blur=0..10}] if predicate flash:sound run playsound entity.firework_rocket.twinkle player @a ~ ~1.3 ~ 0.2 2 0.2
execute if entity @s[tag=SpeedLvl35,scores={flash.time_speed_blur=0..5}] if predicate flash:sound run playsound entity.firework_rocket.twinkle player @a ~ ~1.3 ~ 0.4 2 0.4
execute if entity @s[tag=SpeedLvl69,scores={flash.time_speed_blur=0..3}] if predicate flash:sound run playsound entity.firework_rocket.twinkle player @a ~ ~1.3 ~ 0.6 2 0.6
execute if entity @s[tag=SpeedLvl10,scores={flash.time_speed_blur=0..1}] if predicate flash:sound run playsound entity.firework_rocket.twinkle player @a ~ ~1.3 ~ 0.8 2 0.8
execute if entity @s[tag=SpeedLvl12,scores={flash.time_speed_blur=0..10}] if predicate flash:sound_1 run playsound entity.firework_rocket.twinkle_far player @a ~ ~1.3 ~ 0.2 2 0.2
execute if entity @s[tag=SpeedLvl35,scores={flash.time_speed_blur=0..5}] if predicate flash:sound_1 run playsound entity.firework_rocket.twinkle_far player @a ~ ~1.3 ~ 0.4 2 0.4
execute if entity @s[tag=SpeedLvl69,scores={flash.time_speed_blur=0..3}] if predicate flash:sound_1 run playsound entity.firework_rocket.twinkle_far player @a ~ ~1.3 ~ 0.6 2 0.6
execute if entity @s[tag=SpeedLvl10,scores={flash.time_speed_blur=0..1}] if predicate flash:sound_1 run playsound entity.firework_rocket.twinkle_far player @a ~ ~1.3 ~ 0.8 2 0.8

execute if score @s flash.time_speed_blur >= .SPEED_BLUR flash.time_speed_blur run kill @s