...
execute positioned ~ ~-1 ~ positioned ^ ^ ^ run function main:liquid_running_cast
execute positioned ~ ~-1 ~ positioned ^-1 ^ ^ run function main:liquid_running_cast
execute positioned ~ ~-1 ~ positioned ^1 ^ ^ run function main:liquid_running_cast
execute positioned ~ ~-1 ~ positioned ^-2 ^ ^-1 run function main:liquid_running_cast
execute positioned ~ ~-1 ~ positioned ^2 ^ ^-1 run function main:liquid_running_cast