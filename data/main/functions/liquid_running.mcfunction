...
execute positioned ~ ~-1 ~ if entity @e[type=marker,tag=liquid_run_block,distance=..6] as @e[type=marker,tag=liquid_run_block,distance=..6] if score @s Time_Liquid_Block < .ONE Time_Liquid_Block run scoreboard players add @s Time_Liquid_Block 1
