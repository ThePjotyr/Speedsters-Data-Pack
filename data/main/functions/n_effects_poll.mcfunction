...
execute if entity @s[scores={Level_V9=3}] as @s[scores={Level_V9=3}] if predicate flash:n_effect run effect give @s instant_damage 1 0 true
execute if entity @s[scores={Level_V9=4..}] as @s[scores={Level_V9=4..}] if predicate flash:n_effect run effect give @s instant_damage 1 1 true