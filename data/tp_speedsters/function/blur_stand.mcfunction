...
execute if entity @s[tag=tp.tp.speedsters.speedforce.blur,tag=tp.speedsters.lvl.35] run particle dust_color_transition{from_color:[1.0,0.686,0.008],to_color:[1.0,0.537,0.008],scale:0.45} ~ ~1.3 ~ 0.15 0.35 0.15 0.1 15 force
execute if entity @s[tag=tp.tp.speedsters.speedforce.blur,tag=tp.speedsters.lvl.69] run particle dust_color_transition{from_color:[1.0,0.941,0.42],to_color:[1.0,0.686,0.008],scale:0.45} ~ ~1.3 ~ 0.15 0.35 0.15 0.1 20 force
execute if entity @s[tag=tp.tp.speedsters.speedforce.blur,tag=tp.speedsters.lvl.10] run particle dust_color_transition{from_color:[1.0,0.941,0.42],to_color:[1.0,0.941,0.42],scale:0.5} ~ ~1.3 ~ 0.2 0.4 0.2 0.1 25 force
